    ...
    <Box bgcolor="#E5EDF1" sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
          ...
          <TableContainer component={Paper}>
            <Table aria-label="School and High School Educational Qualifications">
              ...
              <TableBody>
                ...
                {/* DIPLOMA */}
                <StyledTableRow>
                  <StyledTableCell sx={{ padding: "4px" }}>Diploma</StyledTableCell>
        ...
        <Paper component={Box} p={2}>
          <Grid container spacing={2} style={{ justifyContent: "center" }}>
            <Box mt={1} mb={2}>
              {renderText({ label: "Graduation and Post-Graduation Academics Details" })}
            </Box>
          </Grid>
          <TableContainer component={Paper}>
            <Table aria-label="Graduation and Post-Graduation Academics Details">
              ...
              <TableBody>
                <StyledTableRow>
                  <StyledTableCell  sx={{ padding: "4px" }}>Graduation(passed)</StyledTableCell>
                ...
                <StyledTableRow>
                  <StyledTableCell  sx={{ padding: "4px" }}>Post Graduation</StyledTableCell>
