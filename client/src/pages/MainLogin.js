...
export default function MainLogIn(props) {
  ...
  const handleRoute3 = () => {
    navigate("/login/account-section");
  };
...
//   const handleRoute1 = () => {
//     navigate("/login/candidate");  //navigate("/login/candidate");
//   };

//   const handleRoute2 = () => {
//     navigate("/login/staff");  //navigate("/login/staff");
//   };

//   const handleRoute3 = () => {
//     navigate("/login/account-section");   //navigate("/login/account-section");
//   };
